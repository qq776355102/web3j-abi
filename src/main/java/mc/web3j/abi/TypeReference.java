 ...
 * This is so that we can pass around Typed {@link mc.web3j.abi.datatypes.Array} types.
 *
 ...
 */
public abstract class TypeReference<T extends mc.web3j.abi.datatypes.Type>
    ...
    public static <T extends mc.web3j.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
    ...
    public abstract static class StaticArrayTypeReference<T extends mc.web3j.abi.datatypes.Type>
